...
from bormental_md_bot.lexicon.library_ikb_lexicon import (
    MENU_IKB,
    BOOK_INFO_BUT,
    GO_MAIN_MENU,
    TY_BUTTONS,
...
def get_book_info(book_id: str, db_book_cb: str) -> InlineKeyboardMarkup:
    """Interaction with the book (reviews, content, etc.)."""
...
def say_ty_menu(answer: str, field=None, pagination=None) -> InlineKeyboardMarkup:
    """
    Close message. If there is a lot of text, then pagination is created.
