...
# a tuple with numbers controls the position of the buttons in the row
...
# cb data must be named the same as the fields in the database
BOOK_INFO_BUT = (
